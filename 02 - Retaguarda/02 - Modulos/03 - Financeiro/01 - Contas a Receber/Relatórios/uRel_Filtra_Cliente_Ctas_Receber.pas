unit uRel_Filtra_Cliente_Ctas_Receber;
...
type
  TFrRel_Filtra_Cliente_Ctas_Receber = class(TForm)
    Print: TRLReport;
    RLBand1: TRLBand;
    RLLabel1: TRLLabel;
...
var
  FrRel_Filtra_Cliente_Ctas_Receber: TFrRel_Filtra_Cliente_Ctas_Receber;
...
procedure TFrRel_Filtra_Cliente_Ctas_Receber.RLDBText10BeforePrint(Sender: TObject; var AText: string; var PrintIt: Boolean);
begin
...
procedure TFrRel_Filtra_Cliente_Ctas_Receber.RLDBText7BeforePrint(Sender: TObject; var AText: string; var PrintIt: Boolean);
begin
   aText := aText + ' dias';
end;

procedure TFrRel_Filtra_Cliente_Ctas_Receber.RLLabel16BeforePrint(Sender: TObject; var AText: string; var PrintIt: Boolean);
begin
   aText := 'PEDÍODO SELECIONADO: ' + DatetoStr(vr_DataIni) + ' - ' + DateToStr(vr_DataFim);
end;

procedure TFrRel_Filtra_Cliente_Ctas_Receber.RLLabel1BeforePrint(Sender: TObject; var AText: string; var PrintIt: Boolean);
begin
   aText := FEmpresaClass.RazaoSocial;
end;

procedure TFrRel_Filtra_Cliente_Ctas_Receber.RLSubDetail1BeforePrint(Sender: TObject; var PrintIt: Boolean);
begin
