object FrContasPagarExcluir: TFrContasPagarExcluir
  Left = 0
  Top = 0
  BorderStyle = bsNone
  ClientHeight = 359
  ...
  object RzPanel2: TRzPanel
    ...
    object Label9: TLabel
      ...
      Align = alLeft
      Caption = 
        'Selecione um cliente, informe o per'#237'odo e clique em filtrar para' +
        ' exibir as contas registradas.'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -12
      Font.Name = 'Tahoma'
  ...
  object RzPanel3: TRzPanel
    ...
    object Label10: TLabel
      ...
      Width = 112
      Height = 13
      Caption = 'Per'#237'odo do Lan'#231'amento'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Tahoma'
  ...
  object Query: TFDQuery
    ...
    SQL.Strings = (
      'SELECT   '
      '   ID,'
      '   CAST(PAG_DATA_INCLUSAO AS DATE) AS PAG_DATA_INCLUSAO,'
      '   PAG_VALOR,'
      '   PAG_STATUS,'
      '   PAG_FORNECEDOR,'
      '   CASE PAG_ORIGEM'
      '      WHEN 1 THEN '#39'Pedido de Compras'#39
      '      WHEN 2 THEN '#39'NF-e de Entrada'#39
      '      WHEN 3 THEN '#39'Avulso'#39
      '   END AS PAG_ORIGEM,'
      
        '   COALESCE((SELECT SUM(PAG_VLR_RECEBIDO) FROM C000212 WHERE ID_' +
        'C000210 = C000210.ID),0) AS PAG_VLR_RECEBIDO,'
      '   PAG_DOCUMENTO'
      'FROM'
      '   C000210'
      '')
    ...
    object QueryPAG_DATA_INCLUSAO: TDateField
    ...
    object QueryPAG_STATUS: TIntegerField
      FieldName = 'PAG_STATUS'
      Origin = 'PAG_STATUS'
    end
    object QueryPAG_FORNECEDOR: TStringField
      FieldName = 'PAG_FORNECEDOR'
      Origin = 'PAG_FORNECEDOR'
      Size = 120
    end
    object QueryPAG_ORIGEM: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'PAG_ORIGEM'
      Origin = 'PAG_ORIGEM'
      ProviderFlags = []
    ...
    object QueryPAG_DOCUMENTO: TStringField
      FieldName = 'PAG_DOCUMENTO'
      Origin = 'PAG_DOCUMENTO'
      Size = 25
    end
    object QueryPAG_VALOR: TFMTBCDField
      FieldName = 'PAG_VALOR'
      Origin = 'PAG_VALOR'
      DisplayFormat = ',0.00'
      Precision = 18
    ...
    object QueryPAG_VLR_RECEBIDO: TFMTBCDField
      AutoGenerateValue = arDefault
      FieldName = 'PAG_VLR_RECEBIDO'
