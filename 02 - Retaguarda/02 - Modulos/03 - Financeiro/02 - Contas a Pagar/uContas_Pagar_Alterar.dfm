object FrContas_Pagar_Alterar: TFrContas_Pagar_Alterar
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'FrContas_Pagar_Alterar'
  ClientHeight = 120
  ClientWidth = 586
  Color = clGray
  ...
  object RzDialogButtons1: TRzDialogButtons
    ...
    GradientColorStart = 168
    GradientColorStop = 108
    TabOrder = 1
  ...
  object Query: TFDQuery
    ...
    SQL.Strings = (
      'SELECT * FROM C000211 WHERE ID = :ID')
    Left = 26
    Top = 86
    ParamData = <
      item
    ...
    object QueryID_C000210: TLargeintField
      FieldName = 'ID_C000210'
      Origin = 'ID_C000210'
    end
    object QueryPAG_PARCELA: TIntegerField
    ...
    object QueryPAG_ANOTACOES: TStringField
    ...
    object QueryPAG_VLR_ATUALIZADO: TFMTBCDField
    ...
    object QueryPAG_VLR_SALDO: TFMTBCDField
