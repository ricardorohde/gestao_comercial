object FrPedidosVendasGerenciar: TFrPedidosVendasGerenciar
  ...
  object Panel2: TPanel
    ...
    object Panel1: TPanel
      ...
      object Label6: TLabel
        ...
        Width = 139
        Height = 19
        Hint = 'Valor total dos juros sobre o(s) produto(s).'
        Margins.Bottom = 0
        Align = alTop
        Caption = 'Total dos Juros:'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWhite
        Font.Height = -16
        Font.Name = 'Calibri'
  ...
  object tbDados: TFDQuery
    ...
    object tbDadosPED_VLR_JUROS: TBCDField
      FieldName = 'PED_VLR_JUROS'
      Origin = 'PED_VLR_JUROS'
      DisplayFormat = ',0.00'
      Precision = 18
      Size = 2
    end
    object tbDadosPED_VLR_FRETE: TBCDField
    ...
    object tbDadosPED_VLR_SEGURO: TBCDField
    ...
    object tbDadosPED_VLR_OUTROS: TBCDField
    ...
    object tbDadosPED_VLR_DESCONTOS: TBCDField
    ...
    object tbDadosPED_VLR_TOTAL: TBCDField
    ...
    object tbDadosPED_QTDE_ITENS: TBCDField
      FieldName = 'PED_QTDE_ITENS'
      Origin = 'PED_QTDE_ITENS'
      DisplayFormat = '000'
      Precision = 18
    end
    object tbDadosPED_VLR_SUBTOTAL: TBCDField
    ...
    object tbDadosPED_VOLUME_PESO_L: TBCDField
      FieldName = 'PED_VOLUME_PESO_L'
      Origin = 'PED_VOLUME_PESO_L'
      Precision = 18
      Size = 3
    end
    object tbDadosPED_VOLUME_PESO_B: TBCDField
  ...
  object tbItens: TFDQuery
    ...
    object tbItensPRD_VLR_TOTAL: TBCDField
      FieldName = 'PRD_VLR_TOTAL'
