object FrEmissorNfePagtos: TFrEmissorNfePagtos
  Left = 0
  Top = 0
  ...
  object tbDados: TFDQuery
    ...
    SQL.Strings = (
      ...
      '   T1.*,'
        ...
        '   (SELECT DISTINCT (LPAD(FRM_CODIGO,2,0) || '#39' - '#39' || FRM_DESCRI' +
        'CAO) AS FRM_DESCRICAO FROM C000010 WHERE FRM_CODIGO = T1.ID_FORM' +
        'A_PAGTO),'
      
        '   (SELECT SUM(PAG_VLR_SUBTOTAL) FROM C000602 WHERE ID_NOTA_FISC' +
        'AL = :ID) AS SUM_PAG_VLR_SUBTOTAL'
      'FROM'
      '   C000602 AS T1'
      'WHERE'
      '   ID_NOTA_FISCAL = :ID'
    ...
    object tbDadosID_NOTA_FISCAL: TIntegerField
    ...
    object tbDadosVLR_PAGTOS: TAggregateField
      FieldName = 'VLR_PAGTOS'
      Active = True
      DisplayName = ''
      DisplayFormat = ',0.00'
  ...
  object SP_EfetuarRateio: TFDStoredProc
    AfterExecute = SP_EfetuarRateioAfterExecute
    Connection = FrModuloRet.DBConexao
    StoredProcName = 'SP_C000601_RATEIO_PRODUTOS'
    Left = 277
    Top = 196
    ParamData = <
      item
