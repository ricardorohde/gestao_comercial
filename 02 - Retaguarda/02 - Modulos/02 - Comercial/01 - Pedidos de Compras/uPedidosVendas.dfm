object Form1: TForm1
  ...
  object tbDados: TFDQuery
    ...
    SQL.Strings = (
      ...
      '   *'
      'FROM'
      '   VW_PEDIDOS_COMPRAS AS T1'
      'WHERE'
      '   ID_EMPRESA = :ID_EMPRESA'
      'AND'
      '   PED_DATA_PEDIDO BETWEEN :IDATA AND :FDATA'
      'ORDER BY'
      '   PED_DATA_PEDIDO DESC')
    Left = 40
    Top = 160
    ParamData = <
      item
    ...
    object tbDadosPED_COND_PAGTO: TIntegerField
      FieldName = 'PED_COND_PAGTO'
      Origin = 'PED_COND_PAGTO'
    end
    object tbDadosPED_DISCRIMINACAO: TStringField
      FieldName = 'PED_DISCRIMINACAO'
      Origin = 'PED_DISCRIMINACAO'
      Size = 60
    end
    ...
    object tbDadosTOTAL_ITENS: TBCDField
    ...
    object tbDadosTOTAL_PEDIDO: TBCDField
      AutoGenerateValue = arDefault
  ...
  object tbItens: TFDQuery
    ...
    object tbItensITM_QTDE: TBCDField
      FieldName = 'ITM_QTDE'
      Origin = 'ITM_QTDE'
      DisplayFormat = ',0.000'
      Precision = 18
    ...
    object tbItensITM_VLR_TOTAL: TBCDField
      FieldName = 'ITM_VLR_TOTAL'
