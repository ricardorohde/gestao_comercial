...
type
  TFrEmissorNfeCancelar = class(TForm)
    RzPanel2: TRzPanel;
    Panel6: TPanel;
    lbTitulo: TLabel;
    Image2: TImage;
...
var
  FrEmissorNfeCancelar: TFrEmissorNfeCancelar;

implementation

{$R *.dfm}

procedure TFrEmissorNfeCancelar.eJustificativaChange(Sender: TObject);
begin
   lbCaracteres.Caption := Concat(' Total de Caracteres: ', Format('%.4d',[Length(eJustificativa.Text)]));
end;

procedure TFrEmissorNfeCancelar.RzDialogButtons1ClickOk(Sender: TObject);
begin
