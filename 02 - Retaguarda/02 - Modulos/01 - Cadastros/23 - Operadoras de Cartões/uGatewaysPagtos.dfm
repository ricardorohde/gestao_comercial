object FrGatewaysPagtos: TFrGatewaysPagtos
  ...
  object RzPanel2: TRzPanel
    ...
    object Label9: TLabel
      ...
      Height = 30
      Caption = 
        'Gateways de Pagamentos s'#227'o respons'#225'veis por efetuar a transa'#231#227'o ' +
        'dos pagamentos efetuados por Cart'#245'es de Cr'#233'ditos e D'#233'bitos quand' +
        'o se usa TEF, POS e outros nos PDVs.'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -13
      Font.Name = 'Calibri'
  ...
  object tbDados: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT * FROM C000011 WHERE ID_EMPRESA = :ID_EMPRESA ORDER BY GT' +
        'W_CODIGO ASC')
    Left = 464
    Top = 264
    ParamData = <
    ...
    object tbDadosGTW_DATA_REG: TSQLTimeStampField
      FieldName = 'GTW_DATA_REG'
      Origin = 'GTW_DATA_REG'
    end
    object tbDadosGTW_CODIGO: TIntegerField
      AutoGenerateValue = arAutoInc
      FieldName = 'GTW_CODIGO'
      Origin = 'GTW_CODIGO'
      DisplayFormat = '000000'
    end
    object tbDadosGTW_DESCRICAO: TStringField
      FieldName = 'GTW_DESCRICAO'
      Origin = 'GTW_DESCRICAO'
      Size = 60
    end
    object tbDadosGTW_STATUS: TIntegerField
      Alignment = taCenter
      FieldName = 'GTW_STATUS'
      Origin = 'GTW_STATUS'
      OnGetText = tbDadosGTW_STATUSGetText
    end
    object tbDadosGTW_TAXA: TBCDField
      FieldName = 'GTW_TAXA'
      Origin = 'GTW_TAXA'
      DisplayFormat = ',0.00'
      Precision = 18
