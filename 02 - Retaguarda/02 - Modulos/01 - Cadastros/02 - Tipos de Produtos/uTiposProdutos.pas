...
var
  FrTiposProdutos: TFrTiposProdutos;
...
procedure TFrTiposProdutos.actAlterarExecute(Sender: TObject);
begin
   tbDados.Edit;
end;

procedure TFrTiposProdutos.actAlterarUpdate(Sender: TObject);
begin
...
procedure TFrTiposProdutos.actCadastrarExecute(Sender: TObject);
begin
   tbDados.Insert;
end;

procedure TFrTiposProdutos.actCadastrarUpdate(Sender: TObject);
begin
   TAction(Sender).Enabled := not ( tbDados.State in [dsInsert,dsEdit] );
end;

procedure TFrTiposProdutos.actCancelarExecute(Sender: TObject);
begin
   tbDados.Cancel;
end;

procedure TFrTiposProdutos.actExcluirExecute(Sender: TObject);
begin
   tbdados.Delete;
end;

procedure TFrTiposProdutos.actGravarExecute(Sender: TObject);
begin
   tbDados.Post;
end;

procedure TFrTiposProdutos.actGravarUpdate(Sender: TObject);
begin
   TAction(Sender).Enabled := tbDados.State in [dsInsert,dsEdit];
end;

procedure TFrTiposProdutos.actSairExecute(Sender: TObject);
begin
   Self.Close;
end;

procedure TFrTiposProdutos.actSairUpdate(Sender: TObject);
begin
   TAction(Sender).Enabled := not ( tbDados.State in [dsInsert,dsEdit] );
end;

procedure TFrTiposProdutos.dsDadosStateChange(Sender: TObject);
begin
...
procedure TFrTiposProdutos.FormClose(Sender: TObject; var Action: TCloseAction);
begin
   FreeAndNil( FrTiposProdutos );
end;

procedure TFrTiposProdutos.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
...
procedure TFrTiposProdutos.FormCreate(Sender: TObject);
begin
...
procedure TFrTiposProdutos.pgControlChanging(Sender: TObject; var AllowChange: Boolean);
begin
   AllowChange := tbDados.State in [dsInsert,dsEdit];
end;

procedure TFrTiposProdutos.tbDadosAfterPost(DataSet: TDataSet);
begin
   DataSet.Refresh;
end;

procedure TFrTiposProdutos.tbDadosBeforeDelete(DataSet: TDataSet);
begin
...
procedure TFrTiposProdutos.tbDadosBeforePost(DataSet: TDataSet);
begin
...
procedure TFrTiposProdutos.tbDadosNewRecord(DataSet: TDataSet);
begin
   {Dados básicos do cadastros}
   DataSet.FieldByName('ID_EMPRESA').AsInteger    := FEmpresaClass.ID;
   DataSet.FieldByName('TIP_DATA_REG').AsDateTime := now;
   DataSet.FieldByName('TIP_STATUS').AsInteger    := 1;
end;

procedure TFrTiposProdutos.tbDadosTIP_STATUSGetText(Sender: TField; var Text: string; DisplayText: Boolean);
begin
   if DisplayText then
   begin
