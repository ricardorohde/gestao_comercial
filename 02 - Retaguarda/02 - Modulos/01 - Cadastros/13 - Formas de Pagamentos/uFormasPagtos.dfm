object FrFormasPagtos: TFrFormasPagtos
  Left = 0
  Top = 0
  ...
  object RzPanel2: TRzPanel
    ...
    object Label9: TLabel
      ...
      Height = 30
      Caption = 
        'Neste formul'#225'rio ser'#227'o cadastradas as formas de pagamentos, esta' +
        's ser'#227'o utilizadas em todos os processo de vendas inclusive nos ' +
        'terminais de vendas do sistema.'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -13
      Font.Name = 'Calibri'
  ...
  object tbDados: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT * FROM C000010 WHERE ID_EMPRESA = :ID_EMPRESA ORDER BY FR' +
        'M_CODIGO ASC')
    Left = 464
    Top = 264
    ParamData = <
    ...
    object tbDadosFRM_DATA_REG: TSQLTimeStampField
      FieldName = 'FRM_DATA_REG'
      Origin = 'FRM_DATA_REG'
    end
    object tbDadosFRM_CODIGO: TIntegerField
      FieldName = 'FRM_CODIGO'
      Origin = 'FRM_CODIGO'
      DisplayFormat = '00'
    end
    ...
    object tbDadosFRM_STATUS: TIntegerField
      Alignment = taCenter
      FieldName = 'FRM_STATUS'
      Origin = 'FRM_STATUS'
      OnGetText = tbDadosFRM_STATUSGetText
    end
  end
