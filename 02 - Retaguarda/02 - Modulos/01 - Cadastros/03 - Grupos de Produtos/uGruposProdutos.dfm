object FrGruposProdutos: TFrGruposProdutos
  Left = 0
  Top = 0
  BorderStyle = bsNone
  ...
  object tbDados: TFDQuery
    ...
    object tbDadosGRP_CODIGO: TIntegerField
      AutoGenerateValue = arAutoInc
      FieldName = 'GRP_CODIGO'
      Origin = 'GRP_CODIGO'
      DisplayFormat = '000000'
    end
    object tbDadosGRP_DATA_REG: TSQLTimeStampField
      FieldName = 'GRP_DATA_REG'
      Origin = 'GRP_DATA_REG'
    end
    ...
    object tbDadosGRP_STATUS: TIntegerField
      Alignment = taCenter
      FieldName = 'GRP_STATUS'
      Origin = 'GRP_STATUS'
      OnGetText = tbDadosGRP_STATUSGetText
    end
  end
