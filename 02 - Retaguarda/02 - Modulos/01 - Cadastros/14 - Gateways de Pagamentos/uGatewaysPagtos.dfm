object FrGatewaysPagtos: TFrGatewaysPagtos
  ...
  object RzPanel2: TRzPanel
    ...
    object Label9: TLabel
      ...
      Height = 30
      Caption = 
        'Gateways de Pagamento s'#227'o interfaces utilizadas por empresas par' +
        'a a transmiss'#227'o de dados entre clientes, comerciantes e seus ban' +
        'cos.'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -13
  ...
  object tbDados: TFDQuery
    ...
    object tbDadosGTW_TAXA: TFMTBCDField
      FieldName = 'GTW_TAXA'
      Origin = 'GTW_TAXA'
      DisplayFormat = ',0.00'
      Precision = 18
