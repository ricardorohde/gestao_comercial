...
type
  TFrGatewaysPagtos = class(TForm)
    ...
    tbDadosGTW_DATA_REG: TSQLTimeStampField;
    tbDadosGTW_CODIGO: TIntegerField;
    tbDadosGTW_DESCRICAO: TStringField;
    tbDadosGTW_STATUS: TIntegerField;
    JvDBCalcEdit1: TJvDBCalcEdit;
    Label4: TLabel;
    tbDadosGTW_TAXA: TFMTBCDField;
...
procedure TFrGatewaysPagtos.tbDadosGTW_STATUSGetText(Sender: TField; var Text: string; DisplayText: Boolean);
begin
   if DisplayText then
   begin
