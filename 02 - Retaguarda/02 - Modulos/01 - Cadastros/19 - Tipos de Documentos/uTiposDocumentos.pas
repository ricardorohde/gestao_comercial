...
type
  TFrTiposDocumentos = class(TForm)
    RzPanel2: TRzPanel;
    Label8: TLabel;
    Label9: TLabel;
    Bevel3: TBevel;
    ...
    procedure tbDadosTIPO_STATUSGetText(Sender: TField; var Text: string;
      DisplayText: Boolean);
...
var
  FrTiposDocumentos: TFrTiposDocumentos;
...
procedure TFrTiposDocumentos.actAlterarExecute(Sender: TObject);
begin
   tbDados.Edit
end;

procedure TFrTiposDocumentos.actAlterarUpdate(Sender: TObject);
begin
...
procedure TFrTiposDocumentos.actCadastrarExecute(Sender: TObject);
begin
   tbDados.Insert;
end;

procedure TFrTiposDocumentos.actCadastrarUpdate(Sender: TObject);
begin
   TAction(Sender).Enabled := not( tbDados.State in [dsInsert,dsEdit] );
end;

procedure TFrTiposDocumentos.actCancelarExecute(Sender: TObject);
begin
   tbDados.Cancel;
end;

procedure TFrTiposDocumentos.actCancelarUpdate(Sender: TObject);
begin
   if tbDados.IsEmpty then
      TAction(Sender).Enabled := false
   else
...
procedure TFrTiposDocumentos.actExcluirExecute(Sender: TObject);
begin
   tbDados.Delete;
end;

procedure TFrTiposDocumentos.actExcluirUpdate(Sender: TObject);
begin
   if tbDados.IsEmpty then
      TAction(Sender).Enabled := false
   else
...
procedure TFrTiposDocumentos.actGravarExecute(Sender: TObject);
begin
   tbDados.Post;
end;

procedure TFrTiposDocumentos.actGravarUpdate(Sender: TObject);
begin
   if tbDados.IsEmpty then
      TAction(Sender).Enabled := false
   else
...
procedure TFrTiposDocumentos.actSairExecute(Sender: TObject);
begin
   Self.Close;
end;

procedure TFrTiposDocumentos.dsDadosStateChange(Sender: TObject);
begin
...
procedure TFrTiposDocumentos.FormClose(Sender: TObject; var Action: TCloseAction);
begin
   FreeAndNil( FrTiposDocumentos );
end;

procedure TFrTiposDocumentos.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
...
procedure TFrTiposDocumentos.FormCreate(Sender: TObject);
begin
...
procedure TFrTiposDocumentos.pgControlChanging(Sender: TObject; var AllowChange: Boolean);
begin
   AllowChange := tbDados.State in [dsInsert,dsEdit];
end;

procedure TFrTiposDocumentos.tbDadosAfterPost(DataSet: TDataSet);
begin
   DataSet.Refresh;
end;

procedure TFrTiposDocumentos.tbDadosBeforeDelete(DataSet: TDataSet);
begin
...
procedure TFrTiposDocumentos.tbDadosBeforePost(DataSet: TDataSet);
begin
...
procedure TFrTiposDocumentos.tbDadosNewRecord(DataSet: TDataSet);
begin
   {Dados básicos do cadastros}
   DataSet.FieldByName('ID_EMPRESA').AsInteger     := FEmpresaClass.ID;
   DataSet.FieldByName('TIPO_DATA_REG').AsDateTime := now;
   DataSet.FieldByName('TIPO_STATUS').AsInteger    := 1;
end;

procedure TFrTiposDocumentos.tbDadosTIPO_STATUSGetText(Sender: TField; var Text: string; DisplayText: Boolean);
begin
   if DisplayText then
   begin
