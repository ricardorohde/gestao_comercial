...
uses
   uTipoFornecedor, Classe.Empresa, uModuloRet;
...
begin
   ...
   try
      ...
      case tbDados.State of
         ...
         dsInsert :
         begin
            tbPesq.SQL.Add('SELECT 1 FROM C000305 WHERE FOR_CNPJ = :FOR_CNPJ AND ID_EMPRESA = :ID_EMPRESA');
         ...
         dsEdit :
         begin
            tbPesq.SQL.Add('SELECT 1 FROM C000305 WHERE ID <> :ID AND FOR_CNPJ = :FOR_CNPJ AND ID_EMPRESA = :ID_EMPRESA');
