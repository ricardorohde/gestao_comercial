...
type
   TFrEmpresas = class(TForm)
      ...
      tbDadosEMP_MDF_AMBIENTE: TIntegerField;
      tbDadosEMP_MDF_TIPO_DANFE: TIntegerField;
      tbDadosEMP_MDF_PNUMERO: TIntegerField;
      tbDadosEMP_MDF_PLOTE: TIntegerField;
      tbDadosEMP_MDF_PSERIE: TIntegerField;
      tbDadosEMP_MDF_HNUMERO: TIntegerField;
      tbDadosEMP_MDF_HLOTE: TIntegerField;
      tbDadosEMP_MDF_HSERIE: TIntegerField;
      tbDadosEMP_MDF_TIPO_EMISSAO: TIntegerField;
      tbDadosEMP_MDF_TIPO_XJUST: TStringField;
      RzGroupBox18: TRzGroupBox;
      Label77: TLabel;
      RzDBButtonEdit4: TRzDBButtonEdit;
      tbDadosEMP_MDF_FOLDER_XSD: TStringField;
      RzDBButtonEdit5: TRzDBButtonEdit;
      Label81: TLabel;
      tbDadosEMP_MDF_FOLDER_LOG: TStringField;
      RzDBEdit24: TRzDBEdit;
      Label82: TLabel;
      Label83: TLabel;
      RzDBEdit28: TRzDBEdit;
      tbDadosEMP_MDF_PMODELO: TIntegerField;
      tbDadosEMP_MDF_HMODELO: TIntegerField;
...
begin
   try
      ...
      begin
         ...
         tbDadosEMP_PLN_PDV_DESC.AsString := FrListaPlanoContas.QueryPLN_CONTA_CODIGO.AsString + ' - ' + FrListaPlanoContas.QueryPLN_DESCRICAO.AsString;
      end;
   finally
...
begin
   try
      ...
      begin
         ...
         tbDadosEMP_CLI_PDV_DESC.AsString := Format('%.6d', [FrListaClientes.QueryCLI_CODIGO.AsInteger]) + ' - ' + FrListaClientes.QueryCLI_RAZAO_SOCIAL.AsString;
      end;
   finally
...
begin
   try
      ...
      begin
         ...
         tbDadosEMP_PLN_NFE_EDESC.AsString := FrListaPlanoContas.QueryPLN_CONTA_CODIGO.AsString + ' - ' + FrListaPlanoContas.QueryPLN_DESCRICAO.AsString;
      end;
   finally
      FreeAndNil(FrListaPlanoContas);
   end;
...
begin
   try
      ...
      begin
         ...
         tbDadosEMP_PLN_PED_CDESC.AsString := FrListaPlanoContas.QueryPLN_CONTA_CODIGO.AsString + ' - ' + FrListaPlanoContas.QueryPLN_DESCRICAO.AsString;
      end;
   finally
      FreeAndNil(FrListaPlanoContas);
   end;
...
begin
   try
      ...
      begin
         ...
         tbDadosEMP_PLN_PED_VDESC.AsString := FrListaPlanoContas.QueryPLN_CONTA_CODIGO.AsString + ' - ' + FrListaPlanoContas.QueryPLN_DESCRICAO.AsString;
      end;
   finally
      FreeAndNil(FrListaPlanoContas);
   end;
...
begin
   try
      ...
      begin
         ...
         tbDadosEMP_PLN_NFE_SDESC.AsString := FrListaPlanoContas.QueryPLN_CONTA_CODIGO.AsString + ' - ' + FrListaPlanoContas.QueryPLN_DESCRICAO.AsString;
      end;
   finally
      FreeAndNil(FrListaPlanoContas);
   end;
...
begin
   try
      ...
      begin
         ...
         tbDadosEMP_PLN_OS_DESC.AsString := FrListaPlanoContas.QueryPLN_CONTA_CODIGO.AsString + ' - ' + FrListaPlanoContas.QueryPLN_DESCRICAO.AsString;
      end;
   finally
      FreeAndNil(FrListaPlanoContas);
   end;
...
begin
   ...
   if Assigned(FrEmissorNfe) then
      application.MessageBox
         ('Foi detectado que o emissor de notas fiscais esta aberto, para que as alterações tenham efeitos feche o emissor antes de emitir uam nova nota fiscal.', 'TechCore-RTG',
