object FrBandeirasCartoes: TFrBandeirasCartoes
  Left = 0
  Top = 0
  Caption = 'Bandeiras de Cart'#245'es'
  ClientHeight = 541
  ClientWidth = 1099
  Color = clGray
  ...
  object RzPanel2: TRzPanel
    ...
    object Label9: TLabel
      ...
      Height = 30
      Caption = 
        'Formul'#225'rio respons'#225'vel por cadastrar e manter as Bandeiras das A' +
        'dministradoras de Cart'#245'es, s'#227'o necess'#225'rias caso se use Gateways ' +
        'de Pagamentos no sistema de Frente de Caixa.'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -13
      Font.Name = 'Calibri'
  ...
  object tbDados: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT * FROM C000012 WHERE ID_EMPRESA = :ID_EMPRESA ORDER BY BN' +
        'D_CODIGO ASC')
    Left = 464
    Top = 264
    ParamData = <
    ...
    object tbDadosBND_DATA_REG: TSQLTimeStampField
      FieldName = 'BND_DATA_REG'
      Origin = 'BND_DATA_REG'
    end
    object tbDadosBND_CODIGO: TIntegerField
      FieldName = 'BND_CODIGO'
      Origin = 'BND_CODIGO'
      DisplayFormat = '00'
    end
    object tbDadosBND_DESCRICAO: TStringField
      FieldName = 'BND_DESCRICAO'
      Origin = 'BND_DESCRICAO'
      Size = 60
    end
    object tbDadosBND_STATUS: TIntegerField
      Alignment = taCenter
      FieldName = 'BND_STATUS'
      Origin = 'BND_STATUS'
      OnGetText = tbDadosBND_STATUSGetText
    end
  end
