...
begin
   ...
   try
      try
         ...
         aQueryR.SQL.Add(' COALESCE((SELECT NCM_TAXA_IMP     FROM C000300 WHERE NCM_CODIGO = T2.PRD_NCM AND NCM_EX = T2.PRD_NCM_EX AND ID_EMPRESA = :ID_EMPRESA),0) AS PRD_NCM_TAXA_IMP,');
         aQueryR.SQL.Add(' COALESCE((SELECT NCM_TAXA_NAC     FROM C000300 WHERE NCM_CODIGO = T2.PRD_NCM AND NCM_EX = T2.PRD_NCM_EX AND ID_EMPRESA = :ID_EMPRESA),0) AS PRD_NCM_TAXA_NAC,');
         aQueryR.SQL.Add(' COALESCE((SELECT NCM_TAXA_EST     FROM C000300 WHERE NCM_CODIGO = T2.PRD_NCM AND NCM_EX = T2.PRD_NCM_EX AND ID_EMPRESA = :ID_EMPRESA),0) AS PRD_NCM_TAXA_EST');
         aQueryR.SQL.Add('FROM');
